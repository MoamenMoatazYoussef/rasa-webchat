...
export const SET_AUTOCOMPLETE_CALL_DESTINATION = 'SET_AUTOCOMPLETE_CALL_DESTINATION';
export const SET_AUTOCOMPLETE_ELEMENTS_TO_REPLACE = 'SET_AUTOCOMPLETE_ELEMENTS_TO_REPLACE';
export const SET_AUTOCOMPLETE_STATE = 'SET_AUTOCOMPLETE_STATE';
export const SET_AUTOCOMPLETE_CURRENT_INPUT = 'SET_AUTOCOMPLETE_CURRENT_INPUT';
export const SET_AUTOCOMPLETE_SELECTED = 'SET_AUTOCOMPLETE_SELECTED';
export const SET_AUTOCOMPLETE_POSITIONS = 'SET_AUTOCOMPLETE_POSITIONS';
export const SET_AUTOCOMPLETE_ALTERED_INPUT = 'SET_AUTOCOMPLETE_ALTERED_INPUT';
